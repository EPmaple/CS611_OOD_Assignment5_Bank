...
public class ManagerViewCustomersFrame extends JFrame implements CurrencyModelListener, BalanceListener, DeleteAccountListener{
  ...
  public void accountDeleted(String customerName) {
    String msg = "One of your customer's accounts has been deleted";
    regenerateFrame(msg);
  }
